...
export type IUpdateInformationSchema = z.infer<typeof UpdateInformationSchema>

export const UpdatePasswordSchema = z.object({
    currentPassword: z.string().min(8).max(28),
    newPassword: z.string().min(8).max(28).regex(PASSWORD_REGEX, "must contain at least 1 symbol, 1 upercase, 1 lowercase and a number"),
